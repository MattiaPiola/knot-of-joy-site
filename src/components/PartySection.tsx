            ...
            <div className="space-y-6">
              {timeline.map((item, index) => (
                <div key={index} className="flex items-start space-x-4">
                  <div className="bg-wedding-brick/20 p-3 rounded-full">
                    {item.icon}
                  </div>
                  
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-1">
                      <span className="font-inter font-bold text-wedding-brick">
                        {item.time}
                      </span>
          ...
          <div className="space-y-8">
            <div className="bg-wedding-cream/50 p-6 rounded-lg">
              ...
              <div className="space-y-4 font-inter text-gray-600">
                ...
                <div>
                  <strong className="text-gray-800">Parcheggio:</strong><br />
                  Parcheggio disponibile in loco
                </div>
              </div>
            </div>

            <div className="bg-wedding-dust/20 p-6 rounded-lg">
